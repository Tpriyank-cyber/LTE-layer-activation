# -*- coding: utf-8 -*-
"""
Created on Thu Feb  5 12:39:03 2026

@author: tpriyank
"""

# =========================================================
# FULL BBH STREAMLIT VERSION (100% MATCH TO ORIGINAL SCRIPT)
# =========================================================
...
# UI
# =========================================================
st.title("📊 Nokia BBH KPI Tool")

bbh = st.file_uploader("BBH Long", type="xlsx")
day = st.file_uploader("Daily", type="xlsx")
sector = st.file_uploader("Sector", type="xlsx")
...
if st.button("Run Full Analysis"):
    ...
    if not (bbh and day and sector):
        ...
        with st.spinner("Processing all 11 sheets..."):
